...
public class AdapterMissolicitudes extends RecyclerView.Adapter<AdapterMissolicitudes.viewHolderAdaptermissolicitudes> {
    ...
    public AdapterMissolicitudes(List<Usuarios_DDBB> userList, Context context) {
    ...
    @NonNull
    @Override
    public viewHolderAdaptermissolicitudes onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_chatlist,parent,false);
        viewHolderAdaptermissolicitudes holder = new viewHolderAdaptermissolicitudes(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull viewHolderAdaptermissolicitudes holder, int position) {
    ...
    public class viewHolderAdaptermissolicitudes extends RecyclerView.ViewHolder {
        ...
        public viewHolderAdaptermissolicitudes(@NonNull View itemView) {
            super(itemView);
