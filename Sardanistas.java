...
public class Sardanistas extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sardanistas);
...
/*ref_contador.addValueEventListener(new ValueEventListener() {
        @Override
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            if(snapshot.getValue().toString().equals("0")){
                Toast.makeText(getApplicationContext(),"No estàs apuntat a cap activitat", Toast.LENGTH_LONG).show();
            }else{
