...
public class AdapterSolicitudes extends RecyclerView.Adapter<AdapterSolicitudes.viewHolderAdaptersolicitudes> {
    ...
    public AdapterSolicitudes(List<Usuarios_DDBB> userList, Context context) {
    ...
    @NonNull
    @Override
    public viewHolderAdaptersolicitudes onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_chatlist,parent,false);
        viewHolderAdaptersolicitudes holder = new viewHolderAdaptersolicitudes(v);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull viewHolderAdaptersolicitudes holder, int position) {
    ...
    public class viewHolderAdaptersolicitudes extends RecyclerView.ViewHolder {
        ...
        public viewHolderAdaptersolicitudes(@NonNull View itemView) {
            super(itemView);
